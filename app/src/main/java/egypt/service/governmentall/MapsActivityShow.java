...
/**
 * Created by falcon on 01/11/2017.
 */
...
//        mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
    ...
    private void insertMarkers(ArrayList<LatLng> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            final MarkerOptions options = new MarkerOptions().position(position).title(getGeocodeName(list.get(i).latitude,list.get(i).longitude));
